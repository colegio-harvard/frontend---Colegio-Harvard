...
export default function AlertasInternas() {
  ...
  const confirmarAccion = async (alerta) => {
    ...
    const pregunta = esDerivacion
      ? 'Confirme únicamente cuando el alumno se encuentre físicamente en la oficina. La alerta continuará activa hasta pulsar Resolver. ¿Confirmar recepción?'
      : 'Confirme únicamente cuando administración haya atendido el aviso. La alerta continuará activa hasta pulsar Resolver. ¿Confirmar atención?';
