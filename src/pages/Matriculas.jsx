...
export default function Matriculas() {
  ...
  const detailData = detail?.aceptado_en ? (detail.datos_formulario || {}) : (Object.keys(detail?.borrador_asistido || {}).length ? detail.borrador_asistido : (detail?.datos_formulario || {}));
