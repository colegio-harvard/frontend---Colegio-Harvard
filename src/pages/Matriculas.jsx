  ...
  return <div className="space-y-6 pb-10">
    ...
    {showConfig && <Card title={`Configuración ${data.anio.anio}`}>
      <form onSubmit={saveConfig} className="grid gap-4 md:grid-cols-2">
        <label className="text-sm text-primary-700">Inicio<input name="fecha_inicio" type="date" defaultValue={String(config.fecha_inicio || '').slice(0, 10)} className={`${field} mt-1`} /></label>
        <label className="text-sm text-primary-700">Cierre<input name="fecha_fin" type="date" defaultValue={String(config.fecha_fin || '').slice(0, 10)} className={`${field} mt-1`} /></label>
        <label className="text-sm text-primary-700">Nombre del paquete documental<input name="nombre_documentos" defaultValue={config.nombre_documentos || 'Documentos oficiales de matrícula'} className={`${field} mt-1`} /></label>
        <label className="text-sm text-primary-700">Versión de documentos<input name="version_documentos" defaultValue={config.version_documentos || '1.0'} className={`${field} mt-1`} /></label>
        <label className="text-sm text-primary-700 md:col-span-2">Enlace anual de Google Drive<input name="enlace_documentos" type="url" placeholder="https://drive.google.com/..." defaultValue={config.enlace_documentos || ''} className={`${field} mt-1`} /></label>
