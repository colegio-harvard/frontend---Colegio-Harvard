...
export const exportarReportePagosExcel = (params = {}) => apiClient.get('/pensiones/reporte-pagos/exportar-excel', { params, responseType: 'blob' });
...
export const dashboardPensiones = () => apiClient.get('/pensiones/dashboard');
